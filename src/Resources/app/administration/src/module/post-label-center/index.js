...
Module.register('post-label-center', {
    ...
    routeMiddleware(next, currentRoute) {
        ...
        if (currentRoute.name === 'sw.order.detail' && currentRoute.children.every((currentRoute) => currentRoute.name !== orderDocumentsRoute && currentRoute.name !== returnOrdersRoute)) {
            currentRoute.children.push({
                component: 'shipping-document-tab', name: orderDocumentsRoute, meta: {
                    parentPath: 'sw.order.index'
                }, path: '/sw/order/detail/:id/shipping-document'
            }, {
                component: 'order-return-tab', name: returnOrdersRoute, meta: {
                    parentPath: 'sw.order.index'
